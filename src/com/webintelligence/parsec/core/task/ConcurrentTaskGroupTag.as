...
import com.webintelligence.parsec.core.task.parsleyTaskClasses.ConcurrentTaskGroup;
 ...
 */
public class ConcurrentTaskGroupTag 
    extends ConcurrentTaskGroup
{
     ...
     *  @private
     */
    private static const LOG:Logger = LogContext.getLogger(ConcurrentTaskGroup);
